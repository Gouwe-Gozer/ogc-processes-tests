...
The testcase checks that the client keeps nested objects, arrays, empty
...
See
[`../../testcases/execution-sync/deeply-nested-json-output/`](../../testcases/execution-sync/deeply-nested-json-output/).
